...
$( document ).ready(function() {
    displayHTML = "<table><tr><th>Year</th><th>Jan</th><th>Feb</th><th>Mar</th><th>Apr</th><th>May</th><th>Jun</th><th>Jul</th><th>Aug</th><th>Sep</th><th>Oct</th><th>Nov</th><th>Dec</th><th>Total</th></tr>";
...
var total = 0;
  ...
  for (i = 0; i < serverData.length; i++) {
   ...
   //  window.alert();
      ...
      thisId = year + "-" + month;
    thisRow += "<td>" + year + "</td>";
     thisRow += "<td><input class='textBox' id='" + thisId+ "' value='" + thisValue + "' ";  		thisRow += "onChange='UpdateTotal(\"" + year + "\");' />" + "</td>";
 ...
 total += thisValue;
      ...
      if (month == 12) {
      thisRow +="<td><div id='total" + year + "'>"+ total + "</div></td></tr>";
      displayHTML += thisRow;
     ...
     thisRow = "";
      ...
      for (j=m; j<13; j++) {
            thisId = year + "-" + j;
      thisRow += "<td><input class='textBox' id='" + thisId+ "' value='0' ";  		  thisRow += "onChange='UpdateTotal(\"" + year + "\");' />" + "</td>";
      }
           thisRow +="<td><div id='total" + year + "'>"+ total + "</div></td></tr>";
     displayHTML += thisRow;
      }
...
var saveData = [];
var arrayDisplay = "";
 var years = $("#yearsPresent").val().split(',');
